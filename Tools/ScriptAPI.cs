...
namespace MapleShark2.Tools {
    public sealed class ScriptAPI {
        ...
        [Bindable(false)]
        internal ScriptAPI(StructureForm pStructure) {
        ...
        public bool AddBool(string pName) {
            return mStructure.APIAddBool(pName);
        }
        ...
        public string AddUnicodeString(string pName) {
            return mStructure.APIAddUnicodeString(pName);
        }
        ...
        public string GetFiletime() {
            return mStructure.APIGetFiletime();
        }
