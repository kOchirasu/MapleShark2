...
namespace MapleShark2.Logging {
    public sealed class StructureSegment {
        ...
        public byte? Byte {
            get {
                if (mBuffer.Length >= 1) return mBuffer[0];
                return null;
            }
        }
        ...
        public sbyte? SByte {
            get {
                if (mBuffer.Length >= 1) return (sbyte) mBuffer[0];
                return null;
            }
        }
        ...
        public ushort? UShort {
            get {
                if (mBuffer.Length >= 2) return BitConverter.ToUInt16(mBuffer, 0);
                return null;
            }
        }
        ...
        public short? Short {
            get {
                if (mBuffer.Length >= 2) return BitConverter.ToInt16(mBuffer, 0);
                return null;
            }
        }
        ...
        public uint? UInt {
            get {
                if (mBuffer.Length >= 4) return BitConverter.ToUInt32(mBuffer, 0);
                return null;
            }
        }
        ...
        public int? Int {
            get {
                if (mBuffer.Length >= 4) return BitConverter.ToInt32(mBuffer, 0);
                return null;
            }
        }
        ...
        public float? Float {
            get {
                if (mBuffer.Length >= 4) return BitConverter.ToSingle(mBuffer, 0);
                return null;
            }
        }
        ...
        public ulong? ULong {
            get {
                if (mBuffer.Length >= 8) return BitConverter.ToUInt64(mBuffer, 0);
                return null;
            }
        }
        ...
        public long? Long {
            get {
                if (mBuffer.Length >= 8) return BitConverter.ToInt64(mBuffer, 0);
                return null;
            }
        }
        ...
        public string IpAddress {
            get {
                if (mBuffer.Length == 4) {
                    return string.Format("{0}.{1}.{2}.{3}", mBuffer[0].ToString(), mBuffer[1].ToString(),
                        mBuffer[2].ToString(), mBuffer[3].ToString());
                }
        ...
        public Color Color =>
            mBuffer.Length < 4 ? default : Color.FromArgb(mBuffer[3], mBuffer[2], mBuffer[1], mBuffer[0]);
